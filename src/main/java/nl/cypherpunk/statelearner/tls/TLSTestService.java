...
//	TLS currentTLS = new TLS10();
	...
	public void start() throws Exception {
		if(ROLE_CLIENT) {
			...
			while(!tlsTestService.isReady()) {
				System.out.println("Wait for the client to send the first message (ClientHello)");
				Thread.sleep(10);
			}
		}
	}
	...
	public String toString() {
		return "TLSTestService{" +
				...
				", \nRECEIVE_MSG_TIMEOUT=" + RECEIVE_MSG_TIMEOUT +
				", \nENABLE_HEARTBEAT=" + ENABLE_HEARTBEAT +
				", \nCONSOLE_OUTPUT=" + CONSOLE_OUTPUT +
				", \ncurrentTLS=" + currentTLS +
				", \nOPENSSL_MODE=" + OPENSSL_MODE +
				", \nREUSE_KEYBLOCK=" + REUSE_KEYBLOCK +
				", \nrand=" + rand +
				", \nmaster_secret=" + Arrays.toString(master_secret) +
				", \nverify_data=" + Arrays.toString(verify_data) +
				", \nreadCipher=" + readCipher +
				", \nreadMAC=" + readMAC +
				", \nreadMACSeqNr=" + readMACSeqNr +
				", \nwriteCipher=" + writeCipher +
				", \nwriteMAC=" + writeMAC +
				", \nwriteMACSeqNr=" + writeMACSeqNr +
				", \ncipherSuite=" + cipherSuite +
				", \nserverKey=" + serverKey +
				...
				", \nclient_random=" + Arrays.toString(client_random) +
				", \nserver_random=" + Arrays.toString(server_random) +
				", \nsession_id=" + Arrays.toString(session_id) +
				", \ninitCipherSuite=" + initCipherSuite +
				", \ninitServerKey=" + initServerKey +
				", \ndhPubKey=" + dhPubKey +
				", \ndhPrivateKey=" + dhPrivateKey +
				", \nhandshakeMessages=" + Arrays.toString(handshakeMessages) +
				", \nccs_in=" + ccs_in +
				", \nccs_out=" + ccs_out +
				", \ntmp_key_block=" + Arrays.toString(tmp_key_block) +
				", \ncmd='" + cmd + '\'' +
